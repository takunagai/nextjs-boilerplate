...
export const metadata: Metadata = {
  ...
  description: "Next.js、TypeScript、Tailwind CSSを使用した最新のWebアプリケーション開発のためのボイラープレート",
};
        ...
        <div className="container relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              Next.js、TypeScript、Tailwind CSSを組み合わせた最新のボイラープレートで、
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature) => (
              <div key={feature.id} className="bg-background rounded-lg p-6 shadow-sm border">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" variant="secondary" className="gap-2">
                <a href="https://github.com/yourusername/nextjs-boilerplate" target="_blank" rel="noopener noreferrer">
                  GitHubで見る
...
const features = [
  {
    id: "performance",
    title: "高速パフォーマンス",
    description: "Next.jsのApp Routerを使用した高速なページ読み込みと優れたユーザー体験を実現します。",
  ...
  },
  {
    id: "type-safety",
    title: "型安全性",
    description: "TypeScriptによる型安全なコーディングで、バグを減らし開発効率を向上させます。",
    icon: ({ className }: { className?: string }) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    id: "modern-ui",
    title: "モダンUI",
    description: "Tailwind CSSとshadcn/uiを使用した美しく、カスタマイズ可能なUIコンポーネント。",
    icon: ({ className }: { className?: string }) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
...
const featureList = [
  {
    id: "app-router",
    title: "App Router",
    description: "Next.jsの最新のApp Routerを使用した効率的なルーティングシステム",
  },
  {
    id: "server-components",
    title: "サーバーコンポーネント",
    description: "パフォーマンスを向上させるReactサーバーコンポーネントのサポート",
  },
  {
    id: "form-validation",
    title: "フォームバリデーション",
  ...
  },
  {
    id: "accessible-ui",
    title: "アクセシブルなUI",
    description: "shadcn/uiとRadixを使用したアクセシビリティに優れたUIコンポーネント",
  },
  {
    id: "testing",
    title: "テスト環境",
