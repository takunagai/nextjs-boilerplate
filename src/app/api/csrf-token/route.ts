import { generateCsrfToken, createCsrfCookie, CSRF_CONSTANTS } from "@/lib/security/csrf";
...
export async function GET(request: NextRequest) {
	try {
		...
		response.cookies.set(CSRF_CONSTANTS.COOKIE_NAME, createCsrfCookie(tokenData), {
			httpOnly: true,
