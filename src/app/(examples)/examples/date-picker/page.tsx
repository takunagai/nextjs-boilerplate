  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 space-y-12">
      <header className="mb-10">
        <h1 className="text-4xl font-bold tracking-tight text-primary">DatePicker コンポーネント</h1>
      ...
      <section>
        ...
        <div className="p-4 bg-background rounded-lg shadow space-y-6">
          <div>
            <h3 className="text-xl font-medium mb-2">日付選択コンポーネントの基本実装</h3>
...
`}</code>
          ...
          <div>
            <h3 className="text-xl font-medium mb-2">サーバーコンポーネントでの使用方法</h3>
            <pre className="p-4 rounded bg-muted overflow-x-auto">
...
`}</code>
      ...
      <section>
        <h2 className="text-3xl font-semibold mb-6 border-b pb-2">使用上の注意点</h2>
        <div className="p-4 bg-background rounded-lg shadow space-y-4">
          <div className="p-4 border-l-4 border-amber-500 bg-amber-50 dark:bg-amber-950/20 text-amber-700 dark:text-amber-300">
            ...
            <p className="mt-1">
              DatePickerは内部で <code className="px-1 py-0.5 bg-muted rounded">useState</code> を使用するため、
              クライアントコンポーネントとして実装する必要があります。サーバーコンポーネントで使用する場合は、
              上記のように別ファイルに分離して <code className="px-1 py-0.5 bg-muted rounded">"use client"</code> ディレクティブを追加してください。
            </p>
          </div>
