...
export const WEB_DEV_SERVICES: WebDevServiceItem[] = [
	...
	},
	{
		...
		iconName: "rocket",
		icon: getServiceIcon("rocket"),
		color: "text-green-600",
		gradientFrom: "from-green-600/5",
		description: "Next.js・静的生成による高速サイト",
	},
	{
		id: "wordpress",
		...
		iconName: "wordpress",
		icon: getServiceIcon("wordpress"),
		color: "text-blue-500",
		gradientFrom: "from-blue-500/5",
		description: "CMS・ブログに最適な柔軟性重視",
	},
	{
		id: "web-spot-support",
		...
		iconName: "lifeRing",
		icon: getServiceIcon("lifeRing"),
		color: "text-purple-600",
		gradientFrom: "from-purple-600/5",
		description: "緊急対応・トラブル解決・部分修正",
	},
	{
		id: "frontend-repair",
		title: "フロントエンドリペア",
