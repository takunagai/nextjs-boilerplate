 ...
 */
export type TableCaptionProps = TableChildProps &
	HTMLAttributes<HTMLTableCaptionElement>;

/**
 * TableHeaderコンポーネントのProps
 */
export type TableHeaderProps<TData> = Omit<TableChildProps, "children"> &
 ...
 */
export type TableBodyProps<TData> = Omit<TableChildProps, "children"> &
	HTMLAttributes<HTMLTableSectionElement> & {
		rows: Row<TData>[];
		columns: ColumnDef<TData>[];
	};
 ...
 */
export type TableFooterProps = TableChildProps &
	HTMLAttributes<HTMLTableSectionElement>;

/**
 * TableRowコンポーネントのProps
 */
export type TableRowProps<TData> = Omit<TableChildProps, "children"> &
 ...
 */
export type TableHeadProps<TData> = Omit<TableChildProps, "children"> &
 ...
 */
export type TableCellProps<TData> = Omit<TableChildProps, "children"> &
