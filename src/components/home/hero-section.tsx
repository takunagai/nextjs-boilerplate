...
export function HeroSection() {
	...
	return (
		<section className="relative h-screen w-full flex items-center overflow-hidden">
			...
			<div className="absolute -top-20 -right-20 w-96 h-96 bg-primary/10 rounded-full blur-3xl opacity-70 z-20" />

			{/* アクセント装飾 - 左下の円形グラデーション */}
			<div className="absolute -bottom-20 -left-20 w-80 h-80 bg-primary/20 rounded-full blur-3xl opacity-60 z-20" />
