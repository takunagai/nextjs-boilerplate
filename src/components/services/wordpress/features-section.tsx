...
const features = [
	{
		...
		title: "柔軟なCMS機能",
		description:
			"直感的な管理画面でコンテンツ更新が簡単。投稿・固定ページ・カスタム投稿タイプで多様なコンテンツに対応。",
		benefits: [
			"ドラッグ&ドロップエディタ",
			"メディアライブラリ管理",
			"リビジョン履歴",
	...
	},
	{
		...
		title: "カスタムテーマ開発",
		description:
			"既製テーマに頼らず、オリジナルデザインを完全再現。ブランドイメージを最大限に活かします。",
	...
	},
	{
		...
		title: "SEO最適化",
		description:
			"検索エンジンに評価されるサイト構造・コンテンツ設計。アクセス数向上をサポートします。",
	...
	},
	{
		...
		title: "セキュリティ強化",
		description:
			"WordPressの脆弱性対策を徹底実装。定期的なセキュリティアップデートで安心運用。",
	...
	},
	{
		...
		title: "マルチデバイス対応",
		description:
			"PC・タブレット・スマートフォン全てで最適表示。モバイルファーストで設計します。",
	...
	},
	{
		...
		title: "拡張性・保守性",
		description:
			"将来の機能追加・アップデートを考慮した設計。長期的な運用コストを抑制します。",
