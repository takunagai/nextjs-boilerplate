...
const processSteps = [
	{
		...
		title: "要件定義・サイト設計",
		description:
			"コンテンツ管理方法・必要機能を詳細ヒアリング。WordPressの特性を最大限活用したサイト設計を提案。",
	...
	},
	{
		...
		title: "デザイン・ワイヤー作成",
		description:
			"ブランドイメージを反映したオリジナルデザイン。WordPressの管理画面も使いやすくカスタマイズ。",
	...
	},
	{
		...
		title: "WordPress開発",
		description:
			"カスタムテーマ作成・プラグイン開発。SEO・セキュリティ・高速化対策も同時実装。",
	...
	},
	{
		...
		title: "デプロイ・公開",
		description:
			"本番環境へのデプロイ・ドメイン設定。セキュリティ対策・バックアップ設定まで一括対応。",
	...
	},
	{
		...
		title: "運用サポート",
		description:
			"運用マニュアル提供・操作レクチャー実施。6ヶ月間の保守サポートで安心運用。",
