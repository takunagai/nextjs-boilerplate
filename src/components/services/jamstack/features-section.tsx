...
const features = [
	{
		...
		title: "超高速表示",
		description:
			"静的生成により平均読み込み時間を90%短縮。CDN配信でグローバル高速表示を実現。",
	...
	},
	{
		...
		title: "堅牢なセキュリティ",
		description:
			"サーバーサイド攻撃リスクを大幅削減。SSL証明書・CSRF対策・XSS対策を標準実装。",
		benefits: [
			"サーバー攻撃リスク ほぼゼロ",
			"自動SSL更新",
			"最新セキュリティパッチ適用",
	...
	},
	{
		...
		title: "SEO最適化",
		description:
			"構造化データ・メタタグ・サイトマップ自動生成。検索エンジン最適化を徹底実装。",
		benefits: [
			"Core Web Vitals 最適化",
			"構造化データ自動生成",
			"サイトマップ自動更新",
	...
	},
	{
		...
		title: "低運用コスト",
		description:
			"静的ホスティングで運用費を大幅削減。サーバー管理・メンテナンス不要で安心運用。",
	...
	},
	{
		...
		title: "完全レスポンシブ",
		description:
			"モバイルファースト設計で全デバイス最適化。PWA対応でアプリライクな体験を提供。",
	...
	},
	{
		...
		title: "拡張性・保守性",
		description:
			"TypeScript・Component設計で将来の機能追加も安心。Git管理で変更履歴も完全管理。",
