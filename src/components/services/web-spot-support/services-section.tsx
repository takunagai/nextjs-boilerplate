...
import { FaBug, FaPalette, FaGears, FaShield, FaMobile, FaMagnifyingGlass } from "react-icons/fa6";
...
const services = [
	{
		...
		examples: ["ページが表示されない", "フォームが送信できない", "レイアウトが崩れている"]
	},
	{
	...
	},
	{
		...
		examples: ["お問い合わせフォーム追加", "SNSボタン追加", "スライダー機能追加"]
	},
	{
	...
	},
	{
		...
		examples: ["スマホでレイアウトが崩れる", "タブレット表示がおかしい", "モバイル最適化"]
	},
	{
