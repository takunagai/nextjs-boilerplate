...
const processSteps = [
	{
		...
		title: "お問い合わせ",
		description:
			"お電話・メール・チャットでお気軽にご相談ください。緊急時は24時間以内にご連絡いたします。",
		duration: "即日",
	},
	{
		step: "02",
		...
		title: "無料見積もり",
		description:
			"現状確認・作業内容精査の上、明確な見積もりを提示。追加料金は一切発生しません。",
		duration: "1-2時間",
	},
	{
		step: "03",
		...
		title: "修正作業",
		description:
			"経験豊富なエンジニアが迅速かつ丁寧に作業を実施。進捗は随時ご報告いたします。",
		duration: "内容による",
	},
	{
		step: "04",
		...
		title: "完了・サポート",
		description:
			"作業完了のご確認をいただき、必要に応じてアフターサポートもご提供いたします。",
		duration: "継続",
	},
];
