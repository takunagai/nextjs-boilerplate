...
import { FRAGMENT_SHADER_PARTICLE, VERTEX_SHADER_PARTICLE } from "@/constants/constellation";

interface ConstellationParticlesProps {
	geometry: THREE.BufferGeometry;
}

export const ConstellationParticles = forwardRef<THREE.Points, ConstellationParticlesProps>(
	({ geometry }, ref) => {
		return (
